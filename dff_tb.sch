...
N -391.25 152.8125 -391.25 153.125 {lab=#net1}
...
N -495.625 -31.25 -495.625 -30 {lab=RSTn}
N -495.625 -31.875 -495.625 -31.25 {lab=RSTn}
N -495.625 -30 -495.625 5 {lab=RSTn}
N -495.625 65 -495.625 100 {lab=GND}
N -495.625 -31.25 -495.625 -30 {lab=RSTn}
N -495.625 -31.875 -495.625 -31.25 {lab=RSTn}
...
C {lab_wire.sym} -697.5 -62.8125 3 0 {name=p1 sig_type=std_logic lab=vdd}
...
C {lab_wire.sym} -486.25 -31.875 0 0 {name=p2 sig_type=std_logic lab=RSTn}
